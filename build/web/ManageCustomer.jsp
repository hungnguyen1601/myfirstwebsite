<%-- 
    ...
    Created on : Nov 16, 2020, 10:55:40 PM
    Author     : Admin
--%>
...
<!--                                            <th class="head-item mbr-fonts-style display-7">
                                    ...
                                    <form action="manageProduct" method="get">
                                        ...
                                        <c:forEach items="${customer}" var="i">
                                            ...
                                            <td class="body-item mbr-fonts-style display-7">${i.getAddress()}</td>
                                            <td class="body-item mbr-fonts-style display-7">${i.getNote()}</td>
                                            <!--<td class="body-item mbr-fonts-style display-7"><a href="manageCustomer?action=Delete&id=${i.getId()}" onclick="return confirm('Are you sure?')">Delete</a></td>-->
                                            <tr>  
                                            </c:forEach>
                                    </form>
                                    </tbody>
